...
export default async function ProjectsPage(){
 ...
 return <main className="nexus-page"><div className="nexus-header"><div><h1>Projects</h1><p>Active pipeline for {profile.name||profile.email}</p></div></div><ProjectsClient projects={projects??[]}/></main>;
}